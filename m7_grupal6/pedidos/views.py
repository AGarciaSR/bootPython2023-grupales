...
def view_pedidos(request):
    if request.user.is_staff:
        pedido_details = Pedido.objects.only('id','date_time','usuario','dir_entrega','estado').order_by('date_time')
    else:
        pedido_details = Pedido.objects.only('id','date_time','usuario','dir_entrega','estado').filter(usuario=request.user).order_by('date_time')
    context = {
